            ...
            <div class="card card-info card-outline">
                <div class="card-header">
                    ...
                    <div class="profil-body">
                        <form action="/simpan-data/{{$user->id}}" method="post" onSubmit="return validateForm()">
                            @METHOD('PUT')
                            @csrf
                            <input type="hidden" name="id" value="{{$user->id}}">
                            <div class="form-group">
                                <p>NIK yang meninggal :</p>
                                <input type="text" id="nik_meninggal" value="{{$user->nik_meninggal}}" name="nik_meninggal" class="form-control" placeholder="" disabled>
                            </div>
                            <div class="form-group">
                                <p>Nama yang meninggal :</p>
                                <input type="text" id="nama_meninggal" value="{{$user->nama_meninggal}}" name="nama_meninggal" class="form-control" placeholder="" disabled>
                            </div>
                            <div class="form-group">
                                <p>Tanggal Meninggal :</p>
                                <input type="date" id="tgl_meninggal" value="{{$user->tgl_meninggal}}" name="tgl_meninggal" class="form-control">
                                <br>
                                <div class="form-group">
                                    <p>Alamat Lengkap Yang Meninggal :</p>
                                    <textarea id="alamat_meninggal" name="alamat_meninggal" class="form-control" placeholder="">{{$user->alamat_meninggal}}</textarea>
                                </div>

                                <div class="form-group">
                                    <p>Kecamatan yang meninggal :</p>
                                    <select id="kecamatan_meninggal" name="kecamatan_meninggal" class="form-control">
                                        <option value="" selected disabled>{{$user->kecamatan_meninggal}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="kelurahan_meninggal" name="kelurahan_meninggal" class="form-control">
                                        <option value="">{{$user->kelurahan_meninggal}}</option>
                                    </select>
                                </div>
                            </div>
                            <p>Nomor Telpon Ahli Waris :</p>
                            <input type="text" id="notelp_ahwa" name="notelp_ahwa" class="form-control" placeholder="" value="{{$user->notelp_ahwa}}">
                    </div>
                    <br>
                    <div class="form-group">
                        <p>Alamat Lengkap Ahli Waris :</p>
                        <textarea id="alamat_ahwa" name="alamat_ahwa" class="form-control" placeholder="">{{$user->alamat_ahwa}}</textarea>
                    </div>
                    <div class="form-group">
                        <p>NIK ahli waris :</p>
                        <input type="text" id="nik_ahwa" value="{{$user->nik_ahwa}}" name="nik_ahwa" class="form-control" placeholder="">
                    </div>
                    <div class="form-group">
                        <p>Nama ahli waris :</p>
                        <input type="text" id="nama_ahwa" value="{{$user->nama_ahwa}}" name="nama_ahwa" class="form-control" placeholder="">
                    </div>

                    <div class="form-group">
                        <p>Kecamtan :</p>
                        <select id="kecamatan_ahwa" name="kecamatan_ahwa" class="form-control">
                            <option value="" selected disabled>{{$user->kecamatan_ahwa}}</option>
                            <option value="Banjarbaru Selatan">Banjarbaru Selatan</option>
                            <option value="Banjarbaru Utara">Banjarbaru Utara</option>
                            <option value="Cempaka">Cempaka</option>
                            <option value="Landasan Ulin">Landasan Ulin</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="kelurahan_ahwa" name="kelurahan_ahwa" class="form-control">
                            <option value="">{{$user->kelurahan_ahwa}}</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <p>Kedudukan ahli waris :</p>
                        <select id="kedudukan" name="kedudukan" class="form-control">
                            <option disabled {{ !$user->kedudukan ? 'selected' : '' }}>Kedudukan ahli waris</option>
                            <option value="Saudara Kandung" {{ $user->kedudukan === 'Saudara Kandung' ? 'selected' : '' }}>Saudara Kandung</option>
                            <option value="Anak Kandung" {{ $user->kedudukan === 'Anak Kandung' ? 'selected' : '' }}>Anak Kandung</option>
                            <option value="Suami" {{ $user->kedudukan === 'Suami' ? 'selected' : '' }}>Suami</option>
                            <option value="Istri" {{ $user->kedudukan === 'Istri' ? 'selected' : '' }}>Istri</option>
                            <option value="Cucu" {{ $user->kedudukan === 'Cucu' ? 'selected' : '' }}>Cucu</option>
                            <option value="Pilihan Lain" {{ $user->kedudukan === 'Pilihan Lain' ? 'selected' : '' }}>Pilihan Lain</option>
                        </select>
